...
architechtural reference. This image can be seen in figure \ref{fig:intarch}.
This image shows five horizontal layers with a utility slice that is common to
all layers.
